...
(function() {
  ...
  module.exports = exports = function(options) {
    var connectAssets, _base, _base1, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    if (options == null) {
      options = {};
    }
    if (connectAssets) {
    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      if ((_ref5 = (_base1 = cssCompilers.less).compress) == null) {
        _base1.compress = true;
      }
    }
    if ((_ref6 = options.servePath) == null) {
      options.servePath = '';
    }
    if ((_ref7 = options.buildDir) == null) {
      options.buildDir = 'builtAssets';
    }
    if ((_ref8 = options.buildFilenamer) == null) {
    ...
    if ((_ref13 = options.forceRemote) == null) {
      options.forceRemote = false;
    }
    if ((_ref14 = options.suppressWarnings) == null) {
