...
(function() {
  ...
  module.exports = exports = function(options) {
    var connectAssets, _base, _base1, _base2, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    if (options == null) {
      options = {};
    }
    if (connectAssets) {
    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      if ((_ref3 = options.suppressWarnings) == null) {
        options.suppressWarnings = true;
      }
    }
    if (options.build) {
      if ((_ref4 = (_base = cssCompilers.css).compress) == null) {
        _base.compress = true;
      }
      if ((_ref5 = (_base1 = cssCompilers.styl).compress) == null) {
        _base1.compress = true;
      }
      if ((_ref6 = (_base2 = cssCompilers.less).compress) == null) {
        _base2.compress = true;
      }
    }
    if ((_ref7 = options.servePath) == null) {
      options.servePath = '';
    }
    if ((_ref8 = options.buildDir) == null) {
      options.buildDir = 'builtAssets';
    }
    if ((_ref9 = options.buildFilenamer) == null) {
      options.buildFilenamer = md5Filenamer;
    }
    if ((_ref10 = options.buildsExpire) == null) {
      options.buildsExpire = false;
    }
    if ((_ref11 = options.detectChanges) == null) {
      options.detectChanges = true;
    }
    if ((_ref12 = options.minifyBuilds) == null) {
      options.minifyBuilds = true;
    }
    if ((_ref13 = options.pathsOnly) == null) {
      options.pathsOnly = false;
    }
    if ((_ref14 = options.forceRemote) == null) {
      options.forceRemote = false;
    }
    if ((_ref15 = options.suppressWarnings) == null) {
      options.suppressWarnings = false;
    }
    if ((_ref16 = options.syncWrites) == null) {
  ...
  ConnectAssets = (function() {
    ...
    ConnectAssets.prototype.createHelpers = function() {
      ...
      context.css = function(route) {
        ...
        if (!(route.match(REMOTE_PATH) || _this.options.forceRemote)) {
          route = _this.options.servePath + _this.compileCSS(route);
        }
        if (_this.options.forceRemote && !route.match(REMOTE_PATH)) {
          route = "/" + route;
        }
      ...
      context.js = function(route, routeOptions) {
        ...
        if (route.match(REMOTE_PATH)) {
          routes = [route];
        } else if (_this.options.forceRemote) {
          routes = ["/" + route];
        } else if (srcIsRemote) {
      ...
      try {
        ...
        if (alreadyCached && this.options.build) {
          ...
          if (this.options.buildDir) {
            buildPath = path.resolve(process.cwd(), this.options.buildDir, filename);
            mkdirRecursive(path.dirname(buildPath), 0x1ed, function() {
              if (_this.options.syncWrites) {
                return fs.writeFileSync(buildPath, img);
              } else {
        ...
        try {
          ...
          if (alreadyCached && this.options.build) {
            ...
            if (this.options.buildDir) {
              ...
              mkdirRecursive(path.dirname(buildPath), 0x1ed, function() {
                if (_this.options.syncWrites) {
                  return fs.writeFileSync(buildPath, css);
                } else {
              ...
              if (changed) {
                ...
                if (buildDir = _this.options.buildDir) {
                  ...
                  return mkdirRecursive(path.dirname(buildPath), 0x1ed, function(err) {
                    if (_this.options.syncWrites) {
                      return fs.writeFileSync(buildPath, concatenation);
                    } else {
    ...
    ConnectAssets.prototype.absPath = function(route) {
      return path.resolve(process.cwd(), path.join(this.options.src, route));
    };
  ...
  exports.cssCompilers = cssCompilers = {
    css: {
      ...
      compileSync: function(sourcePath, source) {
        var callback, css, file, options, result, _base, _ref;
        result = '';
        ...
        libs.cleanCSS || (libs.cleanCSS = (function() {
          try {
        ...
        if (this.compress && libs.cleanCSS) {
          return libs.cleanCSS.process(css, options);
        } else {
          return css;
        }
      }
